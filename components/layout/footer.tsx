              ...
              <div className="flex flex-wrap items-center -mx-4">
                <div className="w-full lg:w-1/3 px-4">
                  <div className="inline-flex items-center gap-2.5">
                    <div className="w-10 h-10 bg-gradient-to-br from-orange-600 to-amber-700 rounded-lg flex items-center justify-center">
                ...
                <div className="w-full lg:w-1/3 px-4">
                  <p className="text-gray-500">© 2025 Zenith. All rights reserved.</p>
                </div>
                <div className="w-full lg:w-1/3 px-4">
                  <div className="flex items-center justify-end">
                    <a className="inline-flex mr-6 text-gray-400 hover:text-orange-700 items-center justify-center transition duration-200" href="#">
                    ...
                    <a className="inline-flex text-gray-400 hover:text-orange-700 items-center justify-center transition duration-200" href="#">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
