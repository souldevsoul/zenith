...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(({
  ...
  const variantClasses = {
    ...
    secondary: 'text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 hover:border-orange-600 focus:ring-orange-500 shadow-sm hover:shadow-none rounded-lg',
    outline: 'text-orange-700 bg-transparent border border-orange-600 hover:bg-orange-50 focus:ring-orange-500 rounded-lg',
